<?php
  ...
  $addins = explode("=", explode("&", $selection)[2])[1];
  $size = explode("=", explode("&", $selection)[3])[1];
  $price = DB::table('sizes')->where('name', $size)->first()->price;
?>
<h2 class="mb-25">Step 6 - Checkout</h2>
<form accept-charset="UTF-8" action="/charge" id="payment-form" method="post">
    {{ csrf_field() }}
    <input type="hidden" name="color" value="<?php echo $color; ?>">
    <input type="hidden" name="glitter" value="<?php echo $glitter; ?>">
    <input type="hidden" name="addins" value="<?php echo $addins; ?>">
  ...
  <div class="form-group">
    ...
    <div class="row">
      ...
      <div class="col-sm-4">
        <input class="form-control" id="city" type="text" name="city" value="" placeholder="City">
      </div>
      <div class="col-sm-4">
        <input class="form-control" id="state" type="text" name="state" value="" placeholder="State">
      </div>
      <div class="col-sm-4">
        <input class="form-control" id="zip" type="text" name="zip" value="" placeholder="Zip">
      </div>
    </div>
  </div>
